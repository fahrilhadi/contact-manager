...
@section('title')
    Edit Contact | Contact Manager App
@endsection
    ...
    <div class="w-full max-w-md px-4 py-6 bg-white border border-gray-200 rounded-xl shadow-lg">
      <form action="{{ route('contacts.update', $contact->id) }}" method="POST" class="space-y-4">
        ...
        <div class="flex flex-col">
          ...
          <input type="text" id="name" name="name" value="{{ old('name', $contact->name) }}" autocomplete="off"
        ...
        <div class="flex flex-col">
          ...
          <input type="email" id="email" name="email" value="{{ old('email', $contact->email) }}" autocomplete="off"
        ...
        <div class="flex flex-col">
          ...
          <input type="text" id="phone" name="phone" value="{{ old('phone', $contact->phone) }}" autocomplete="off"
